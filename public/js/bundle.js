...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, password, passwordConfirm, role) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signed up successfully! Redirecting...');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
exports.addBook = exports.updateSettings = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Book added successfully");
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51JRKIcIIBFFxpA9z7pxuNllCX1zmQb7hfQ7DiJBvSOAVTXGTcsq8ZrbgPSoZgp0umTr0mXzwxkvwirD5evCflGJs00sUjUIldl');

var purchaseBook = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/purchases/checkout-session/".concat(bookId));
  ...
  return function purchaseBook(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
//! Dom elements
// Signup Form
var signupForm = document.querySelector('.form--signup'); // Login Form

var loginForm = document.querySelector('.form--login'); //Logout button

var logoutBtn = document.querySelector('.nav__el--logout'); //Update user data form

var userDataForm = document.querySelector('.form-user-data'); //Update user password form

var userPasswordForm = document.querySelector('.form-user-password'); //Purchase book button

var purchaseBtn = document.getElementById('purchase-book'); //Add book

var addBookForm = document.querySelector('.form--addBook'); // Perform signup
...
if (addBookForm) {
  addBookForm.addEventListener('submit', function (event) {
    ...
    console.log(form);
    (0, _updateSettings.addBook)(form);
  });
}
